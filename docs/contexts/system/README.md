...
プロダクト全体が従う外部規範は [全体の標準仕様](../../standards.md)、Context を跨ぐ語は [用語集](../../glossary.md)、実行単位は [実行時アーキテクチャ](../../architecture/runtime.md)、信頼境界は [脅威モデル](../../design/security/threat-model.md) が持つ。実行手順と検証コマンドは仕様ではなく、リポジトリの `README.md` にある。
