...
契約上の拒否条件は [REQ-APITOKENS-004](../../domain/api-tokens/scenarios.feature.md#rule-req-apitokens-004-管理-api-は-api-アクセストークンの粒度スコープでフェイルクローズに認可する) と [REQ-PLATFORM-004](../../domain/scenarios.feature.md#rule-req-platform-004-周囲資格情報による状態変更は同一オリジンと-csrf-トークンを必要とする) が定める。
