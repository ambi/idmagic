...
規範上の条件は [REQ-OAUTH2-020](../../domain/oauth2/scenarios.feature.md#rule-req-oauth2-020-失効したアクセストークンによる-userinfo-の取得は-invalid_token-で拒否される) と [RFC6750-INVALID-TOKEN](../../domain/oauth2/standards.md#the-oauth-20-authorization-framework-bearer-token-usage) が定める。
