...
idmagic は現状 `User` と `OAuth2Client` (machine 用の client_credentials を含む) しか持たない。
...
[[wi-49-agent-identity-first-class-principal]] の意思決定を確定する。[[ADR-032]] (テナント一級集約)・[[ADR-031]]
