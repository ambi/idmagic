...
- `docs/domain/data-keys/` は Rotate/Disable/Destroy/Bootstrap を
...
## Scope
- **spec**: `docs/domain/data-keys/` の `RotateTenantDataKey` /
...
## Plan
1. specification: `docs/domain/data-keys/` の該当ファイルを更新し `mise run check` を通す
   (`spec-change` Skill)。
