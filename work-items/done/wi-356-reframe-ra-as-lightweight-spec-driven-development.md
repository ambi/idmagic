...
同時に、current-state の仕様と設計が `docs/domain/*/requirements.md` と実装側の
...
`docs/domain/<context>/SPECIFICATION.md` を唯一の current-state 文書とする。TypeSpec と同じ
