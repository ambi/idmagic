...
affected_spec:
  - { path: docs/domain/scenarios.feature.md, requirement: REQ-PLATFORM-001 }
  - { path: docs/domain/scenarios.feature.md, requirement: REQ-PLATFORM-002 }
  ...
  - { path: docs/domain/authorization/scenarios.feature.md, requirement: REQ-AUTHORIZATION-003 }
  - { path: docs/domain/jobs/scenarios.feature.md, requirement: REQ-JOBS-002 }
  - { path: docs/domain/jobs/scenarios.feature.md, requirement: REQ-JOBS-012 }
  - { path: docs/domain/seeding/scenarios.feature.md, requirement: REQ-SEEDING-010 }
  ...
  - { path: docs/domain/oauth2/scenarios.feature.md, requirement: REQ-OAUTH2-027 }
  ...
  - { path: docs/domain/workloadidentity/scenarios.feature.md, requirement: REQ-WORKLOADIDENTITY-001 }
  ...
  - { path: docs/domain/application/scenarios.feature.md, requirement: REQ-APPLICATION-012 }
  - { path: docs/domain/identity-governance/scenarios.feature.md, requirement: REQ-IDGOVERNANCE-001 }
  - { path: docs/domain/identity-governance/scenarios.feature.md, requirement: REQ-IDGOVERNANCE-003 }
primary_use_cases:
