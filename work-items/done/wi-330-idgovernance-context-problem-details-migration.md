...
initial_context:
  specification: [docs/SPECIFICATION.md, docs/domain/identity-governance/SPECIFICATION.md]
...
- `support.WriteBrowserError(...)` を `support.WriteProblem(...)` に機械的に
  置き換える。`docs/domain/identity-governance/SPECIFICATION.md` の該当 model は
