...
initial_context:
  specification:
    - docs/domain/oauth2/SPECIFICATION.md#REQ-OAUTH2-010
...
affected_spec:
  - { path: docs/domain/oauth2/scenarios.feature.md, requirement: REQ-OAUTH2-045 }
...
- `docs/domain/oauth2/SPECIFICATION.md` の DPoP 節に `ath` 検証の normative scenario
