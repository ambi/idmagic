...
affected_spec:
  ...
  - { path: docs/contexts/tenancy/scenarios.feature.md, requirement: REQ-TENANCY-019 }
  - { path: docs/contexts/authentication/scenarios.feature.md, requirement: REQ-AUTHENTICATION-024 }
---
