...
depends_on: []
affected_spec:
  - { path: docs/contexts/identity-management/scenarios.feature.md, requirement: REQ-IDMANAGEMENT-024 }
  - { path: docs/contexts/tenancy/scenarios.feature.md, requirement: REQ-TENANCY-020 }
