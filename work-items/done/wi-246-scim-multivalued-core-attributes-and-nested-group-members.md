...
affected_spec:
  ...
  - { path: docs/domain/sourcing/standards.md, requirement: RFC7644-PATCH }
  - { path: docs/domain/sourcing/scenarios.feature.md, requirement: REQ-SOURCING-006 }
...
- `docs/domain/sourcing/SPECIFICATION.md` の Design と normative scenarios、および関連 TypeSpec
...
- [x] T000 [Spec] `docs/domain/sourcing/SPECIFICATION.md` の Design と normative scenarios に、
