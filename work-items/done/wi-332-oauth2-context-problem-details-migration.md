...
initial_context:
  specification: [docs/SPECIFICATION.md, docs/domain/oauth2/SPECIFICATION.md]
...
`docs/domain/oauth2/SPECIFICATION.md` の `InvalidAuthorizationDetailTypeError` は 422) は
...
- 各 `WriteBrowserError` 呼び出しについて、それが JSON API (ログイン/MFA/同意
  ...
  handler が bind される interface (`docs/domain/oauth2/SPECIFICATION.md` の
