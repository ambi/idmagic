...
initial_context:
  specification:
    - docs/domain/oauth2/SPECIFICATION.md#REQ-OAUTH2-027
    - docs/domain/oauth2/SPECIFICATION.md#REQ-OAUTH2-012
    - docs/domain/oauth2/SPECIFICATION.md#REQ-OAUTH2-032
    - docs/domain/oauth2/SPECIFICATION.md#RFC8628-POLLING
  typespec:
...
affected_spec:
  ...
  - { path: docs/domain/oauth2/scenarios.feature.md, requirement: REQ-OAUTH2-042 }
  - { path: docs/domain/oauth2/scenarios.feature.md, requirement: REQ-OAUTH2-043 }
  - { path: docs/domain/oauth2/standards.md, requirement: CIBA-CORE-BACKCHANNEL-REQUEST }
