...
initial_context:
  specification:
    - docs/domain/oauth2/SPECIFICATION.md#REQ-OAUTH2-046
...
**(1) 仕様と実装が乖離している。** `docs/domain/oauth2/SPECIFICATION.md` は Token Exchange の
...
- `docs/domain/oauth2/SPECIFICATION.md` に、テナント上限を超える委譲が拒否される
