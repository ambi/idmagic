...
initial_context:
  ...
  stop_before_reading:
    - frontend
affected_spec:
  - { path: docs/domain/oauth2/standards.md, requirement: RFC9728-CHALLENGE }
  - { path: spec/contexts/oauth2/main.tsp, symbol: IdMagic.OAuth2.Operations.GetProtectedResourceMetadata }
  - { path: docs/domain/oauth2/scenarios.feature.md, requirement: REQ-OAUTH2-044 }
---
...
RFC 9728 の standards 表 (`docs/domain/oauth2/SPECIFICATION.md`) にも
...
- `docs/domain/oauth2/SPECIFICATION.md` の RFC 9728 standards 表にチャレンジ要件を追加し、
