...
completion:
  ...
  summary: "Seeding bounded context、明示 profile、冪等な plan/apply、独立 CLI と運用手順を実装した。"
  verification:
    - "just yaml-check"
    - "just verify-go"
  ...
  evidence:
    - id: "yaml-check"
      ...
      procedure: "SCL/Architecture/Work Item validation"
      result: "passed"
    - id: "verify-go"
      kind: "test"
      procedure: "Go lint and race-enabled tests"
      result: "passed"
    - id: "seed-development-dry-run"
      kind: "runtime_observation"
      procedure: "development profile dry-run"
      result: "passed; create plan contained only redacted logical keys"
