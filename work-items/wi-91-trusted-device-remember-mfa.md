...
- **scl**:
  ...
  - §3.5 invariants: MFA 判定に trusted device を織り込みつつ、期間上限・ 失効・step-up 時無視を明示する。
...
## Tasks
- [ ] T001 [SCL] TrustedDevice lifecycle、tenant/application remember policy、issue/evaluate/revoke interfaces、events/invariants/scenarios を追加して再生成する。
