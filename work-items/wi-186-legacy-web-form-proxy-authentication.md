...
- **decision**:
  - `docs/contexts/application/decisions.md` に、標準フェデレーションを優先する境界、秘密情報の保管/発行境界、
...
- **architecture / documentation**:
  - `docs/README.md` と `docs/structure.md` に LegacyAccess context と依存方向を同期する。
...
- [ ] T003 [Spec] 代理認証の安全境界と運用例外を `docs/contexts/application/decisions.md` に記録する。
