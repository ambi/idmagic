...
## Motivation
`backend/identitymanagement/adapters/http/admin_lifecycle_workflow_handler.go` (327 行、
...
## Scope
- `backend/identitymanagement/adapters/http/admin_lifecycle_workflow_handler_test.go` を新設し、
