...
- **documentation**:
  - `spec/deployment.md` にフリート規模のリファレンストポロジ図（LB → N app レプリカ → PostgreSQL）を、新設する `spec/capacity.md` に想定規模・上限の方針・縮退の順序を書く。
...
- [ ] T004 [Doc] `spec/deployment.md` に参照トポロジを、`spec/capacity.md` に容量前提を書く。
