...
affected_spec:
  ...
  - { path: docs/domain/identity-governance/scenarios.feature.md, requirement: REQ-IDGOVERNANCE-002 }
...
[[wi-347-admin-pagination-totals-and-compact-cursors]] が完了し、`docs/design/application/api-guidelines.md` は管理用一覧 API に
...
## Plan
- pagination は既存のキーセットカーソル契約 (`docs/design/application/api-guidelines.md`、[[wi-347-admin-pagination-totals-and-compact-cursors]])
