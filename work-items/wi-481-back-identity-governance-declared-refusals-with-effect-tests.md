...
depends_on: []
affected_spec:
  - { path: docs/contexts/identity-governance/scenarios.md, requirement: REQ-IDGOVERNANCE-006 }
  - { path: docs/contexts/identity-governance/scenarios.md, requirement: REQ-IDGOVERNANCE-007 }
  - { path: docs/contexts/identity-governance/scenarios.md, requirement: REQ-IDGOVERNANCE-011 }
  - { path: docs/contexts/identity-governance/scenarios.md, requirement: REQ-IDGOVERNANCE-012 }
---
