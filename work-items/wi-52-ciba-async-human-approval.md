...
## Tasks
- [ ] T001 [ADR/SCL] ADR-051 を既存 Agent/TokenExchange/RAR 型へ確定し、request lifecycle、CIBA endpoints/errors、approval interfaces/events/invariants/scenarios を追加して再生成する。
