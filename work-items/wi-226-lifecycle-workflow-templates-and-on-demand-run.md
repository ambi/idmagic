...
affected_spec:
  ...
  - { path: docs/domain/identity-governance/scenarios.feature.md, requirement: REQ-IDGOVERNANCE-013 }
...
- [ ] T002 [Decision] on-demand run の対象選定方針と trigger 評価バイパスの整合性を `docs/domain/identity-governance/decisions.md` に記録する。
