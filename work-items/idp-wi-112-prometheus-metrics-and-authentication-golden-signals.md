---
id: idp-wi-112-prometheus-metrics-and-authentication-golden-signals
title: "Prometheus メトリクスエンドポイントと認証ゴールデンシグナルを公開し SLO 計測を可能にする"
...
---
# Motivation
現状 idmagic は OpenTelemetry トレーシング (idp-wi-107) の導入は計画しているが、
