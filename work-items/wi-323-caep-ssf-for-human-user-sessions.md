...
[[wi-58-continuous-access-evaluation-agent-revocation]] / `docs/domain/sharedsignals/` は Motivation・specification
(`docs/domain/sharedsignals/`)・実装のいずれも Agent プリンシパル限定でスコープされている。
...
- `docs/domain/sharedsignals/` (`scenarios.feature.md`、`internals.md`、`models.tsp`):
...
- `docs/domain/oauth2/` (`scenarios.feature.md`、`internals.md`):
