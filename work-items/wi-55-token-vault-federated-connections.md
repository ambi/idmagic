...
- [ ] T002 [specification/Architecture] connection/connector/grant lifecycle、authorize/callback/execute/revoke interfaces、events/constraints/contracts を追加し、新 context を ARCHITECTURE に同期する。
