...
change_kind: feature
affected_spec:
  - { path: docs/domain/standards.md, requirement: WCAG22-KEYBOARD }
  - { path: docs/domain/standards.md, requirement: WCAG22-FOCUS }
  - { path: docs/domain/standards.md, requirement: WCAG22-LABELS-ERRORS }
  - { path: docs/domain/standards.md, requirement: WCAG22-STATUS }
---
