...
## Scope
- `docs/domain/tenancy/internals.md` の `TenantBranding` の適用先と `GetTenantBranding` の利用側、`docs/domain/system/scenarios.feature.md` の管理コンソールテーマ適用シナリオと fail-open の扱い。
