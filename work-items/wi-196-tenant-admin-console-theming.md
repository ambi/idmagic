...
affected_spec:
  ...
  - { path: docs/contexts/system/scenarios.feature.md, requirement: REQ-SYSTEM-009 }
...
## Scope
- `docs/contexts/tenancy/internals.md` の `TenantBranding` の適用先と `GetTenantBranding` の利用側、`docs/contexts/system/scenarios.feature.md` の管理コンソールテーマ適用シナリオと fail-open の扱い。
