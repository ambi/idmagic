...
(`spec/contexts/identity-management/SPECIFICATION.md` L1642-1645)、テナントごとの件名・本文・変数のカスタマイズ
...
## Scope
- `spec/contexts/identity-management/SPECIFICATION.md` (または既存の通知/email を扱う context) に
