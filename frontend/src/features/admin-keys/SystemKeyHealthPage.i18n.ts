...
export const systemKeyHealthDictionary = defineDictionary(
  {
    ...
    pageDescription:
      '全テナントの署名鍵プロバイダ（Local / Postgres / VaultTransit）の稼働状況と active kid を横断で確認します。',
  ...
  },
  {
    ...
    pageDescription:
      "Check the status of each tenant's signing key provider (Local / Postgres / VaultTransit) and its active kid across the fleet.",
