...
describe('DelegationPolicyTab', () => {
  ...
  //spec:covers REQ-TENANCY-021, EX-TENANCY-021-01, EX-TENANCY-021-02, EX-TENANCY-021-05: 現在値とシステム既定を表示し、厳しい上書きを保存して空欄から 0 を送り継承へ戻す。
  ...
  //spec:covers REQ-TENANCY-021, EX-TENANCY-021-03: システム上限を超える値は往復前に presentation logic で拒否する。
