...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.GET("/api/admin/v1/saml/service-providers", d.handleListServiceProviders)
	g.POST("/api/admin/v1/saml/service-providers", d.handleUpsertServiceProvider)
	g.DELETE("/api/admin/v1/saml/service-providers", d.handleDeleteServiceProvider)
	g.GET("/api/admin/v1/saml/idp-profiles", d.handleListIDPProfiles)
	g.POST("/api/admin/v1/saml/idp-profiles", d.handleCreateIDPProfile)
	g.PUT("/api/admin/v1/saml/idp-profiles/:profile_id", d.handleUpdateIDPProfile)
	g.DELETE("/api/admin/v1/saml/idp-profiles/:profile_id", d.handleDeleteIDPProfile)
}
