...
// backend/shared/adapters/crypto.JWKResolver's ValidateJWKSURI/safeIPs split).
type Client struct {
...
const maxResponseBytes = 1 << 20 // 1 MiB, mirrors backend/shared/adapters/crypto.maxJWKSBytes
