...
import (
	...
	applicationpg "github.com/ambi/idmagic/backend/application/adapters/persistence/postgres"
	applicationdomain "github.com/ambi/idmagic/backend/application/domain"
	"github.com/ambi/idmagic/backend/provisioning/adapters/persistence/postgres"
...
func seedApplication(tb testing.TB, pool *pgxpool.Pool, tenantID string) *applicationdomain.Application {
	...
	app := &applicationdomain.Application{
		...
		Kind:          applicationdomain.ApplicationFederated,
		Status:        applicationdomain.ApplicationActive,
		Bindings:      []applicationdomain.ProtocolBinding{},
		CategoryIDs:   []string{},
		CreatedAt:     now,
		UpdatedAt:     now,
	}
