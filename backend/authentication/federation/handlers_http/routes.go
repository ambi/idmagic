...
func RegisterRoutes(group *echo.Group, deps Deps) {
	...
	group.GET("/api/account/v1/linked-identities", deps.listLinked)
	group.POST("/api/account/v1/linked-identities/:provider_id", func(c *echo.Context) error { return deps.start(c, c.Param("provider_id"), true) })
	group.DELETE("/api/account/v1/linked-identities/:provider_id", deps.unlink)
	group.GET("/api/admin/v1/identity-providers", deps.listAdmin)
	group.POST("/api/admin/v1/identity-providers", deps.createAdmin)
	group.PUT("/api/admin/v1/identity-providers/:provider_id", deps.updateAdmin)
	group.DELETE("/api/admin/v1/identity-providers/:provider_id", deps.deleteAdmin)
	group.POST("/api/admin/v1/identity-providers/:provider_id/activate", deps.activate)
	group.POST("/api/admin/v1/identity-providers/:provider_id/disable", deps.disable)
	group.POST("/api/admin/v1/identity-providers/:provider_id/refresh", deps.refresh)
	group.POST("/api/admin/v1/identity-providers/:provider_id/test", deps.test)
	group.POST("/api/admin/v1/identity-providers/:provider_id/mapping-preview", deps.previewMapping)
}
