...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.GET("/api/admin/users/:sub/sessions", d.handleAdminListSessions)
	g.POST("/api/admin/users/:sub/sessions/:id/revoke", d.handleAdminRevokeSession)
	g.POST("/api/admin/users/:sub/sessions/revoke_all", d.handleAdminRevokeAllSessions)
