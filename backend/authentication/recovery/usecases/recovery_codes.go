...
import (
	...
	authnports "github.com/ambi/idmagic/backend/authentication/recovery/ports"
...
func GenerateRecoveryCodes(
	...
	if deps.Emit != nil {
		deps.Emit(&authdomain.RecoveryCodesGenerated{
...
func RevokeRecoveryCodes(
	...
	if deps.Emit != nil {
		deps.Emit(&authdomain.RecoveryCodesRevoked{At: now, TenantID: user.TenantID, UserID: user.ID})
	}
	return nil
}
...
func ConsumeRecoveryCode(
	...
	if deps.Emit != nil {
		count := remaining
		deps.Emit(&authdomain.BackupCodeConsumed{
