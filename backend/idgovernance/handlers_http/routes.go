...
func RegisterRoutes(g *echo.Group, d Deps) {
	g.GET("/api/admin/v1/lifecycle-workflows", d.handleListLifecycleWorkflows)
	g.GET("/api/admin/v1/lifecycle-workflows/:workflow_id", d.handleGetLifecycleWorkflow)
	g.POST("/api/admin/v1/lifecycle-workflows", d.handleCreateLifecycleWorkflow)
	g.PUT("/api/admin/v1/lifecycle-workflows/:workflow_id", d.handleUpdateLifecycleWorkflow)
	g.POST("/api/admin/v1/lifecycle-workflows/:workflow_id/enable", d.handleEnableLifecycleWorkflow)
	g.POST("/api/admin/v1/lifecycle-workflows/:workflow_id/disable", d.handleDisableLifecycleWorkflow)
	g.DELETE("/api/admin/v1/lifecycle-workflows/:workflow_id", d.handleDeleteLifecycleWorkflow)
	g.POST("/api/admin/v1/lifecycle-workflows/:workflow_id/dry-run", d.handleDryRunLifecycleWorkflow)
	g.GET("/api/admin/v1/lifecycle-workflows/:workflow_id/runs", d.handleListLifecycleWorkflowRuns)
	g.GET("/api/admin/v1/lifecycle-workflow-runs/:run_id", d.handleGetLifecycleWorkflowRun)
	g.POST("/api/admin/v1/lifecycle-workflow-runs/:run_id/retry", d.handleRetryLifecycleWorkflowRun)
}
