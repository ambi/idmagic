...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.GET("/api/admin/applications/:id", d.handleGetApplication)
	g.PATCH("/api/admin/applications/:id", d.handleUpdateApplication)
	g.DELETE("/api/admin/applications/:id", d.handleDeleteApplication)
	g.POST("/api/admin/applications/:id/icon", d.handleUploadApplicationIcon)
	g.DELETE("/api/admin/applications/:id/icon", d.handleDeleteApplicationIcon)
	g.PATCH("/api/admin/applications/:id/oidc", d.handleUpdateOIDCConfig)
	g.POST("/api/admin/applications/:id/oidc/rotate-secret", d.handleRotateOIDCClientSecret)
	g.POST("/api/admin/applications/:id/oidc/client-secrets", d.handleIssueOIDCClientSecret)
	g.DELETE("/api/admin/applications/:id/oidc/client-secrets/:credential_id", d.handleRevokeOIDCClientSecret)
	g.PATCH("/api/admin/applications/:id/wsfed", d.handleUpdateWsFedConfig)
	g.PATCH("/api/admin/applications/:id/saml", d.handleUpdateSamlConfig)
	g.GET("/api/admin/applications/:id/assignments", d.handleListAssignments)
	g.POST("/api/admin/applications/:id/assignments", d.handleAssignApplication)
	g.DELETE("/api/admin/applications/:id/assignments/:subject_type/:subject_id", d.handleUnassignApplication)
	g.GET("/api/admin/applications/:id/sign-in-policy", d.handleGetSignInPolicy)
	g.PUT("/api/admin/applications/:id/sign-in-policy", d.handleUpdateSignInPolicy)
	...
	g.PUT("/api/admin/applications/:id/categories", d.handleSetApplicationCategories)
