...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.GET("/api/admin/v1/tenant/user-attribute-schema", d.handleGetUserAttributeSchema)
	g.PUT("/api/admin/v1/tenant/user-attribute-schema", d.handleUpdateUserAttributeSchema)
	g.GET("/api/admin/v1/tenant/group-attribute-schema", d.handleGetGroupAttributeSchema)
	g.PUT("/api/admin/v1/tenant/group-attribute-schema", d.handleUpdateGroupAttributeSchema)
	...
	g.GET("/api/admin/v1/tenant/notification-templates", d.handleListNotificationTemplates)
	g.GET("/api/admin/v1/tenant/notification-templates/:template_key/:locale", d.handleGetNotificationTemplate)
	g.PUT("/api/admin/v1/tenant/notification-templates/:template_key/:locale", d.handleUpdateNotificationTemplate)
	g.DELETE("/api/admin/v1/tenant/notification-templates/:template_key/:locale", d.handleResetNotificationTemplate)
	g.POST("/api/admin/v1/tenant/notification-templates/:template_key/:locale/preview", d.handlePreviewNotificationTemplate)
	g.POST("/api/admin/v1/tenant/notification-templates/:template_key/:locale/test", d.handleSendTestNotification)
}
...
func RegisterControlPlaneRoutes(g *echo.Group, d Deps) {
	...
	g.PUT("/api/admin/v1/tenants/:target_tenant_id/endpoint-style", d.handleSetTenantEndpointStyle)
