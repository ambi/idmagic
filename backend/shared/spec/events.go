...
type LifecycleWorkflowEnabled struct {
	At          time.Time `json:"-"`
	TenantID    string    `json:"tenantId"`
	ActorUserID string    `json:"actorUserId"`
	WorkflowID  string    `json:"workflowId"`
...
func (e *LifecycleWorkflowEnabled) EventType() string     { return "LifecycleWorkflowEnabled" }
func (e *LifecycleWorkflowEnabled) OccurredAt() time.Time { return e.At }

type LifecycleWorkflowDisabled struct {
	At          time.Time `json:"-"`
	TenantID    string    `json:"tenantId"`
	ActorUserID string    `json:"actorUserId"`
	WorkflowID  string    `json:"workflowId"`
...
func (e *LifecycleWorkflowDisabled) EventType() string     { return "LifecycleWorkflowDisabled" }
func (e *LifecycleWorkflowDisabled) OccurredAt() time.Time { return e.At }
