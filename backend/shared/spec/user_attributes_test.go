...
func TestUserValidateAcceptsAttributes(t *testing.T) {
	...
	u.Attributes = map[string]AttributeValue{
		"nickname":     {Type: AttributeTypeString, String: new("ally")},
		"region":       {Type: AttributeTypeString, String: new("apac")},
		"phone_number": {Type: AttributeTypeString, String: new("+819012345678")},
	}
...
func TestUserValidateRejectsBadAttributeValue(t *testing.T) {
	...
	u.Attributes = map[string]AttributeValue{
		// type と設定フィールドが不一致。
		"region": {Type: AttributeTypeNumber, String: new("x")},
	}
	if err := u.Validate(); err == nil {
...
func TestAttributeValueRequiresSingleMatchingField(t *testing.T) {
	cases := []struct {
		...
		{"string ok", AttributeValue{Type: AttributeTypeString, String: new("x")}, true},
		{"number ok", AttributeValue{Type: AttributeTypeNumber, Number: new(3.5)}, true},
		{"array ok", AttributeValue{Type: AttributeTypeStringArray, StringArray: []string{"a"}}, true},
		{"type/field mismatch", AttributeValue{Type: AttributeTypeNumber, String: new("x")}, false},
		{"two fields", AttributeValue{Type: AttributeTypeString, String: new("x"), Boolean: new(true)}, false},
		{"no field", AttributeValue{Type: AttributeTypeString}, false},
		{"bad type", AttributeValue{Type: "bogus", String: new("x")}, false},
	}
	for _, c := range cases {
...
func TestValidateAttributesEnforcesEffectiveSchema(t *testing.T) {
	...
	ok := map[string]AttributeValue{
		"region":   {Type: AttributeTypeString, String: new("apac")},
		"nickname": {Type: AttributeTypeString, String: new("ally")}, // builtin
	}
	...
	unknown := map[string]AttributeValue{
		"region":  {Type: AttributeTypeString, String: new("apac")},
		"unknown": {Type: AttributeTypeString, String: new("x")},
	}
	...
	wrongType := map[string]AttributeValue{
		"region": {Type: AttributeTypeNumber, Number: new(1.0)},
	}
...
func TestClaimsForScopesExposesByScope(t *testing.T) {
	...
	u.Attributes = map[string]AttributeValue{
		"nickname":     {Type: AttributeTypeString, String: new("ally")},
		"phone_number": {Type: AttributeTypeString, String: new("+819012345678")},
		"title":        {Type: AttributeTypeString, String: new("Engineer")}, // self_readable, never a claim
	}
	defs := BuiltinUserAttributeDefs()
...
func TestClaimsForScopesReassemblesAddress(t *testing.T) {
	u := validUser()
	u.Attributes = map[string]AttributeValue{
		"address_locality": {Type: AttributeTypeString, String: new("Tokyo")},
		"address_country":  {Type: AttributeTypeString, String: new("JP")},
	}
...
func TestClaimsForScopesCustomAttributeGatedByCustomScope(t *testing.T) {
	u := validUser()
	u.Attributes = map[string]AttributeValue{"region": {Type: AttributeTypeString, String: new("apac")}}
	defs := append(BuiltinUserAttributeDefs(), UserAttributeDef{
		Key: "region", Type: AttributeTypeString, Visibility: AttrVisibilityClaimExposed, ClaimName: new("region"),
	})
