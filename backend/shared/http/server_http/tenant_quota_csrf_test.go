...
func TestTenancyStateChangingAdminRoutesVerifyBrowserRequests(t *testing.T) {
	...
	for _, route := range []struct{ method, path string }{
		...
		{http.MethodPut, prefix + "/api/admin/v1/tenant/user-attribute-schema"},
		{http.MethodPut, prefix + "/api/admin/v1/tenant/group-attribute-schema"},
		...
		{http.MethodPut, prefix + "/api/admin/v1/tenant/notification-templates/password_reset/ja"},
		{http.MethodDelete, prefix + "/api/admin/v1/tenant/notification-templates/password_reset/ja"},
		{http.MethodPost, prefix + "/api/admin/v1/tenant/notification-templates/password_reset/ja/preview"},
		{http.MethodPost, prefix + "/api/admin/v1/tenant/notification-templates/password_reset/ja/test"},
		{http.MethodPost, prefix + "/api/admin/v1/tenants"},
		{http.MethodPatch, prefix + "/api/admin/v1/tenants/acme"},
		{http.MethodPut, prefix + "/api/admin/v1/tenants/acme/endpoint-style"},
