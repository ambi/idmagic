...
func CompileDynamicGroupRule(expression string, defs []userdomain.UserAttributeDef) (*CompiledDynamicGroupRule, error) {
...
func (r *CompiledDynamicGroupRule) Evaluate(user userdomain.User) (bool, error) {
	if !user.IsActive() {
		return false, nil
	}
...
func dynamicRuleDefinitions(defs []userdomain.UserAttributeDef) map[string]idmdomain.AttributeType {
	out := map[string]idmdomain.AttributeType{
		"id": idmdomain.AttributeTypeString, "preferred_username": idmdomain.AttributeTypeString,
		"name": idmdomain.AttributeTypeString, "given_name": idmdomain.AttributeTypeString,
		"family_name": idmdomain.AttributeTypeString, "email": idmdomain.AttributeTypeString,
		"email_verified": idmdomain.AttributeTypeBoolean,
	}
...
func dynamicRuleActivation(user userdomain.User) map[string]any {
	out := map[string]any{
