...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.POST("/api/account/v1/email/change-request", func(c *echo.Context) error { return userhttp.HandleRequestEmailChange(d, c) })
	g.GET("/api/account/v1/email/verify-context", func(c *echo.Context) error { return userhttp.HandleEmailVerifyContext(d, c) })
	g.POST("/api/account/v1/email/verify", func(c *echo.Context) error { return userhttp.HandleConfirmEmailChange(d, c) })
	g.GET("/api/account/v1/data-export", func(c *echo.Context) error { return userhttp.HandleExportAccountData(d, c) })
	...
	g.POST("/api/admin/v1/groups/imports", func(c *echo.Context) error { return grouphttp.HandleImportAdminGroups(d, c) })
	g.POST("/api/admin/v1/groups/imports/:preview_job_id/apply", func(c *echo.Context) error { return grouphttp.HandleApplyAdminGroupImport(d, c) })
	g.GET("/api/admin/v1/groups/imports/:job_id", func(c *echo.Context) error { return grouphttp.HandleGetAdminGroupImport(d, c) })
	...
	g.POST("/api/admin/v1/users/:sub/required-actions", func(c *echo.Context) error { return userhttp.HandleSetUserRequiredAction(d, c) })
	g.DELETE("/api/admin/v1/users/:sub/required-actions/:action", func(c *echo.Context) error { return userhttp.HandleClearUserRequiredAction(d, c) })
