...
func RegisterRoutes(g *echo.Group, d Deps) {
	...
	g.POST("/api/admin/users/exports", func(c *echo.Context) error { return HandleStartUserExport(d, c) })
	g.GET("/api/admin/users/exports", func(c *echo.Context) error { return HandleListUserExports(d, c) })
	g.GET("/api/admin/users/exports/:export_id", func(c *echo.Context) error { return HandleGetUserExport(d, c) })
	g.GET("/api/admin/users/exports/:export_id/file", func(c *echo.Context) error { return HandleDownloadUserExportFile(d, c) })
	g.POST("/api/admin/users/exports/:export_id/cancel", func(c *echo.Context) error { return HandleCancelUserExport(d, c) })
	g.POST("/api/admin/groups/exports", func(c *echo.Context) error { return HandleStartGroupExport(d, c) })
	g.GET("/api/admin/groups/exports", func(c *echo.Context) error { return HandleListGroupExports(d, c) })
	g.GET("/api/admin/groups/exports/:export_id", func(c *echo.Context) error { return HandleGetGroupExport(d, c) })
	g.GET("/api/admin/groups/exports/:export_id/file", func(c *echo.Context) error { return HandleDownloadGroupExportFile(d, c) })
	g.POST("/api/admin/groups/exports/:export_id/cancel", func(c *echo.Context) error { return HandleCancelGroupExport(d, c) })
	g.POST("/api/admin/groups/:group_id/members/exports", func(c *echo.Context) error { return HandleStartGroupMemberExport(d, c) })
	g.GET("/api/admin/groups/:group_id/members/exports", func(c *echo.Context) error { return HandleListGroupMemberExports(d, c) })
	g.GET("/api/admin/groups/:group_id/members/exports/:export_id", func(c *echo.Context) error { return HandleGetGroupMemberExport(d, c) })
	g.GET("/api/admin/groups/:group_id/members/exports/:export_id/file", func(c *echo.Context) error { return HandleDownloadGroupMemberExportFile(d, c) })
	g.POST("/api/admin/groups/:group_id/members/exports/:export_id/cancel", func(c *echo.Context) error { return HandleCancelGroupMemberExport(d, c) })
