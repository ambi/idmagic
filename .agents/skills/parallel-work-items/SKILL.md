...
```sh
git fetch --all --prune
git worktree add -b work-item/repo-wi-42-example ../regenerative-architecture-wi-42 <base-branch>
```

既存 branch を別 worktree に出す例:

```sh
git worktree add ../regenerative-architecture-wi-42 work-item/repo-wi-42-example
```
...
```sh
git worktree list
git -C ../regenerative-architecture-wi-42 status --short --branch
```
...
```text
Use the implement-work-item Skill in /path/to/regenerative-architecture-wi-42.
Implement work-items/repo-wi-42-example.md end to end, verify it, update completion,
...
```sh
git worktree add -b integration/work-items ../regenerative-architecture-integration <base-branch>
cd ../regenerative-architecture-integration
git merge --no-ff work-item/repo-wi-42-example
git merge --no-ff work-item/repo-wi-43-example
```
...
```sh
git -C ../regenerative-architecture-wi-42 status --short
git worktree remove ../regenerative-architecture-wi-42
```
