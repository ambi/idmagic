---
name: new-work-item
description: Create a Regenerative Architecture work item under work-items using the canonical format, requirement/TypeSpec references, tasks, design alternatives, and verification plan.
---
...
4. feature・bugfix・operations は `initial_context` と `affected_spec` に requirement ID / TypeSpec symbol を direct reference する。
