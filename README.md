...
(ADR-148, [repository specification](spec/SPECIFICATION.md#3-envelope-encryption-for-reversible-secrets)): a per-tenant
...
- **Browsable Specification HTML**: generated by `just spec-render` at `spec/generated/docs/index.html`
