...
type WebAuthnCredentialRepository interface {
	ListBySub(ctx context.Context, sub string) ([]*spec.WebAuthnCredential, error)
	FindByCredentialID(ctx context.Context, credentialID string) (*spec.WebAuthnCredential, error)
	Save(ctx context.Context, credential *spec.WebAuthnCredential) error
