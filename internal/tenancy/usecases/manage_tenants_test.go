...
func TestUpdateRejectsWeakerPolicyOverride(t *testing.T) {
	...
	cases := []struct {
		...
		{"shorter min_length", spec.PasswordPolicyOverride{MinLength: new(8)}},
		{"longer max_length", spec.PasswordPolicyOverride{MaxLength: new(256)}},
		{"shorter history_depth", spec.PasswordPolicyOverride{HistoryDepth: new(2)}},
	}
