...
const USAGE = [
  ...
  '                   [--architecture <file>] [--title <string>] [--out <path>]',
  '       scl-to-html --help',
  '',
  '  --scl          SCL YAML document (required).',
  '  --decisions    Directory with CONCEPTION*.md + ADR-*.md (optional).',
  '  --work-items   Directory with *.md work-item records (optional).',
  '  --architecture ARCHITECTURE.md map (optional).',
