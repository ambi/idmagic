...
import { loadArchitecture, loadChanges, loadDecisions, loadSclBundle } from './load.ts'
...
const architecturePath = architectureArg ? resolve(process.cwd(), architectureArg) : null
...
const architecture = architecturePath ? await loadArchitecture(architecturePath) : null
